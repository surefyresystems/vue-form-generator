<template>
	<div class="form-group" :class="getFieldRowClasses(field)">
		...
		<div class="field-wrap">
			<component ref="child" :is="getFieldType(field)" :vfg="vfg" :disabled="fieldDisabled(field)" :model="model" :schema="field" :formOptions="options" @visibility-changed="onVisibilityChanged" @model-updated="onModelUpdated" @validated="onFieldValidated"></component>
